...
function showDriverPosition(position) {
    ...
    console.log("Latitud actual:", latitudActual);
    console.log("Longitud actual:", longitudActual);

    iniciarMapasDelHistorial(latitudActual, longitudActual);
}
...
function iniciarMapasDelHistorial(latitudActual, longitudActual) {
    const viajes = document.querySelectorAll('.card-body.viaje');

    viajes.forEach(viaje => {
        const viajeId = viaje.dataset.viajeId;
        console.log(`Viaje ID: ${viajeId}`);

        const contenedorDeLosDatos = viaje.querySelector(`#datosMapHistorial-${viajeId}`);
        const mapContainer = viaje.querySelector(`#map-${viajeId}`);
        ...
        console.log(`Latitud Salida: ${latitudSalida}, Longitud Salida: ${longitudSalida}`);
        console.log(`Latitud Llegada: ${latitudLlegada}, Longitud Llegada: ${longitudLlegada}`);
