...
public class LoginControladorTest {
	...
	public void init() {
		...
		controladorLogin = new LoginControlador(servicioLoginMock, servicioConductorMock, viajeServicio, clienteServicio);
	...
	public void loginConUsuarioYPasswordCorrectosDeberiaLLevarAHome(){
		// preparacion
		Usuario usuarioEncontrado = new Conductor();
		usuarioEncontrado.setTipoUsuario(TipoUsuario.Conductor);
		...
		// validacion
		assertThat(modelAndView.getViewName(), equalToIgnoringCase("redirect:/homeConductor"));
	}
